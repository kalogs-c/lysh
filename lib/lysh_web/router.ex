defmodule LyshWeb.Router do
  use LyshWeb, :router

  import LyshWeb.UserAuth

  pipeline :browser do
    plug :accepts, ["html"]
    plug :fetch_session
    plug :fetch_live_flash
    plug :put_root_layout, html: {LyshWeb.Layouts, :root}
  ...
  # scope "/api", LyshWeb do
  #   pipe_through :api
  # end

  # Enable LiveDashboard and Swoosh mailbox preview in development
  if Application.compile_env(:lysh, :dev_routes) do
    ...
    scope "/dev" do
      ...
      live_dashboard "/dashboard", metrics: LyshWeb.Telemetry
  ...
  scope "/", LyshWeb do
    ...
    live_session :redirect_if_user_is_authenticated,
      on_mount: [{LyshWeb.UserAuth, :redirect_if_user_is_authenticated}] do
  ...
  scope "/", LyshWeb do
    ...
    live_session :current_user,
      on_mount: [{LyshWeb.UserAuth, :mount_current_user}] do
